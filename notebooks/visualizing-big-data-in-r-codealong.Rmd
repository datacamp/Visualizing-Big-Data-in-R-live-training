...
```{r, install_pkgs, echo = FALSE}
rlib <- "~/lib"
dir.create(rlib)
library(remotes)
install_version("hexbin", "1.28.1", lib = rlib)
install_version("fst", "0.9.2", lib = rlib)
install_version("ggcorrplot", "0.1.3", lib = rlib)
install_version("trelliscopejs", "0.2.5", lib = rlib)
install_version("plotly", "4.9.2.1", lib = rlib)
```
