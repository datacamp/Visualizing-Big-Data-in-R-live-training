...
You may need to set a CRAN mirror in ordre to download packages.
...
You need `tibble`, `ggplot2`, and a way to import a CSV file.
...
```{r, download_la, eval = FALSE}
download.file(
  "https://raw.githubusercontent.com/datacamp/Visualizing-Big-Data-in-R-live-training/master/data/LAhomes.csv",
  "LAhomes.csv"
)
```


The dataset is here (though double-check the directory if you just downloaded the dataset). Run this chunk!
